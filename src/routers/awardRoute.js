...
const {createAward,nominate,getHighestNominee,vote,voteResult,leaderBoardHr,leaderBoard,employeeAwardDashboard,resetAward,winners,recentWinner,latestAward,yournominee,latestAwardHr,latestwinnerHr,totalAward,winnersHr,votingStatistic} = require("../controllers/award")
...
router.get("/vote-statistic/:award",authorize,votingStatistic)
